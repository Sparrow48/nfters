...
const BottomNav = () => {
    return (
        <div className='flex flex-col items-start justify-between gap-10 px-4 pt-10 pb-10 xl:mx-auto lg:grid lg:grid-rows-1 lg:grid-cols-3 lg:gap-7 lg:max-w-8xl 2xl:max-w-9xl xl:px-32'>
